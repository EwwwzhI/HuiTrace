...
- Artifacts prefixed with `huitrace-test-`
...
**Examples:**
- `huitrace-devtest-aarch64-apple-darwin`
- `huitrace-test-x86_64-pc-windows-msvc`
- `huitrace-devtest-ubuntu-22.04-x86_64-unknown-linux-gnu`
