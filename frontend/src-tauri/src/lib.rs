...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            evaluation::utterance_reconstruction::api_export_utterance_reconstruction_artifact,
            evaluation::utterance_reconstruction::api_run_utterance_reconstruction_benchmark,
            evaluation::utterance_reconstruction::api_save_utterance_ground_truth,
            evaluation::utterance_reconstruction::api_load_utterance_ground_truth,
            evaluation::utterance_reconstruction::api_initialize_utterance_ground_truth,
